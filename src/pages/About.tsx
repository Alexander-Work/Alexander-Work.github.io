  ...
  <div className="overflow-y-scroll max-w-6xl mx-auto px-4 py-8">
    <h2 className="text-2xl font-bold mb-4">Some of My Qualifications</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {/* cards */}
        <Card title={webCard.title} content={webCard.content}></Card>
        <Card title={gameCard.title} content={gameCard.content}></Card>
        <Card title={databaseCard.title} content={databaseCard.content}></Card>
        <Card title={appLangCard.title} content={appLangCard.content}></Card>
      </div>
      {/* End of cards */}
