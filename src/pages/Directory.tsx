      ...
      <div>
        ...
        <div className="rounded-2xl p-6 mb-2 border-2 ">
          <div className="flex items-center ">
            <img src="/images/suit-cropped.jpg" alt="dapper" className="mx-5 mb-4 h-100 border-1 object-cover rounded-lg" />
        ...
        <div>
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <img src="/images/peepoWICKED.png" alt="WICKED" className="mx-auto mb-4 h-auto" />
          </div> 
      </div>
    );
  };
